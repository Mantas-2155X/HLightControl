...
namespace KKS_HLightControl
{
    [BepInProcess("KoikatsuSunshine")]
    [BepInPlugin(nameof(KKS_HLightControl), nameof(KKS_HLightControl), VERSION)]
    public class KKS_HLightControl : BaseUnityPlugin
    {
        ...
        private void Awake()
        {
            ...
            var harmony = new Harmony(nameof(KKS_HLightControl));
            harmony.PatchAll(typeof(KKS_HLightControl));
        }
        ...
        private static void AddBtn(Transform background, Transform source, string name, bool resize, UnityAction<bool> clickEvent)
        {
            ...
            newRect.offsetMin = new Vector2(5, oldLMin.y);
            newRect.offsetMax = new Vector2(245, oldLMax.y);
            newRect.sizeDelta = new Vector2(240, 32);
